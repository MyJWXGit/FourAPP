...
public class PersonageActivity extends BaseActivity<LoginPresenter> implements Contract.IView {
    ...
    @BindView(R.id.name)
    TextView name;
    @BindView(R.id.personage_name)
    TextView personageName;
    @BindView(R.id.hospital)
    TextView hospital;
    @BindView(R.id.personage_hospital)
    TextView personageHospital;
    @BindView(R.id.keshi)
    TextView keshi;
    @BindView(R.id.personage_keshi)
    TextView personageKeshi;
    @BindView(R.id.zhicheng)
    TextView zhicheng;
    @BindView(R.id.personage_zhicheng)
    TextView personageZhicheng;
    @BindView(R.id.persongge_jieshao)
    TextView personggeJieshao;
    @BindView(R.id.persongge_lingyu)
