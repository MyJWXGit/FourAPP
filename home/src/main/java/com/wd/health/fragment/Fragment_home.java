...
import com.wd.health.activity.CommonActivity;
import com.wd.health.activity.Edit_SearchActivity;
import com.wd.health.activity.FindInfoActivity;
import com.wd.health.adapter.Department_Adapter;
import com.wd.health.adapter.Information_Adapter;
import com.wd.health.adapter.Plate_List_Adapter;
...
public class Fragment_home extends BaseFragment<HomePresenter> implements Contract.IView {
    ...
    public void onSuccess(Object obj) {
        if (obj instanceof BannerBean) {
            ...
            xBanner.setBannerData(R2.layout.image_fresco, info);
