...
import com.wd.health.ConfirmActivity;
...
public class AutonymActivity extends BaseActivity<MyMessage_Presenter> implements Contract.IView {
    ...
    public void initAccessTokenWithAkSk() {
        OCR.getInstance(AutonymActivity.this).initAccessTokenWithAkSk(
                new OnResultListener<AccessToken>() {
                    ...
                    public void onResult(AccessToken result) {
                        ...
                        Toast.makeText(Message_APP.context, "初始化失败", Toast.LENGTH_SHORT).show();
                    }
                ...
                "MkEqGZoKhivwLrREjLnloErf",
                // 需要自己配置 https://console.bce.baidu.com
                "xLqHvMcr29md1jgU4Wmi5NU7Hrwa2GFL");
    }

    //初始化回调监听
    private static void initLicense() {
        CameraNativeHelper.init(Message_APP.context, OCR.getInstance(Message_APP.context).getLicense(),
